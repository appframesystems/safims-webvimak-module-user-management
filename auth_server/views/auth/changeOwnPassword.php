	...
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<div class="user-form">
				...
				<?= $form->field($model, 'password')->passwordInput(['maxlength' => 255, 'autocomplete'=>'off','placeholder'=>'Password to be 8 characters,uppercase and a special character' ]) ?>

				<?= $form->field($model, 'repeat_password')->passwordInput(['maxlength' => 255, 'autocomplete'=>'off']) ?>
                            <div class="mike" style="margin-left: 280px">
