...
//						'class'=>'webvimark\components\StatusColumn',
//						'attribute'=>'isboard',
//						'visible'=>User::hasPermission('viewisboard'),
//					],
                                             [
						'class'=>'webvimark\components\StatusColumn',
...
//					],
                                                                [
            'class' => 'yii\grid\ActionColumn',
            'template' => '{view} {update} {delete} {link} {block}',
            'buttons' => [
                
                'link' => function ($url,$model,$key) {
                   return Html::a(
                        '<span class="glyphicon glyphicon-warning-sign"></span>', 
                        'actualresetpassword?id='.$model->id);
                },
